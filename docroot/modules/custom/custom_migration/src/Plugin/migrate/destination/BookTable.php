 ...
 * )
 */
class BookTable extends DestinationBase implements ContainerFactoryPluginInterface {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    ...
    // need to set nid and not mlid. This is a patch. Don't have time to properly work it out. But it works!
    $id=array('nid'=>$row->getDestinationProperty('nid'));
